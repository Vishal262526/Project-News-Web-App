...
$sql = "SELECT post.post_id, post.title,post.category,post.description,post.post_img, category.category_name, post.post_date FROM post
        ...
        ?>
                <div class="recent-post">
                    <a class="post-img" href="single.php?id=<?php echo $row['post_id']; ?>">
                        <img src="admin/upload/<?php echo $row['post_img']; ?>" alt="Image not loaded" />
                    </a>
